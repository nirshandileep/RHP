<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Landload_Profile_Comments.ascx.cs"
    Inherits="USA_Rent_House_Project.Land_load.Modules.Landload_Profile_Comments" %>
