            ...
            <ItemTemplate>
                ...
                <div id="DivHouse" runat="server">
                 <asp:HiddenField ID="hdUserId" runat="server" Value='<%# Eval("LandlordId") %>' />
                    ...
                    <asp:HyperLink ID="HyperLink5" CssClass="loginlinks" runat="server" NavigateUrl='<%# Eval("HouseId","~/Land_load/Landload_House_Images_Add.aspx?AccessCode={0}") %>'>House Pictures</asp:HyperLink>
