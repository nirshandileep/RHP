<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Landload_Public_Profile_Comments.ascx.cs"
    Inherits="USA_Rent_House_Project.Land_load.Modules.Landload_Public_Profile_Comments" %>
        ...
        <asp:DataList ID="DataListStudentComments" runat="server" RepeatColumns="1">
            ...
            <ItemTemplate>
                ...
                <div id="Document" runat="server" visible='<%# Eval("CommentTypeId").ToString().Equals("4")%>'>
                    ...
                    To Download File that was Uploaded Please <asp:HyperLink ID="filepath" runat="server" NavigateUrl='<%# Eval("FilePath") %>'>Click Here</asp:HyperLink>
