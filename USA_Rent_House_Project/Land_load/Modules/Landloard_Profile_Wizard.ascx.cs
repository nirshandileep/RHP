            ...
            if (Page.IsValid == true)
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        if (user_check.IsPartialUserEmailExist(txtEmail.Text.Trim().ToLower()))
                        {
                            ShowfullRegistration.Visible = false;
                            ShowPartialUserEmailRequest.Visible = true;
                            lblpartialuserEmail.Text = txtEmail.Text.Trim();
                            lblpartialuserEmail2.Text = txtEmail.Text.Trim();
                        }
                        else
                        {
