    ...
    <div id="formwrapper">
        ...
        <div id="forminner">
            ...
            <p>
                ...
                <asp:RequiredFieldValidator ID="GenderRequired" runat="server" ErrorMessage="Please select Gender" ControlToValidate="DrpGender" ValidationGroup="RegisterStudentValidationGroup" InitialValue="-1">*</asp:RequiredFieldValidator>
            </p>
