...
<div id="StidentProfileHeader" runat="server">
    ...
    <div id="CurrentHouseImage" runat="server">
        ...
        <asp:HyperLink ID="CurrentHouse" CssClass="loginlinks_img" runat="server" NavigateUrl="~/Student/Student_Profile.aspx">View House</asp:HyperLink>
    ...
    <div id="LandloadProfileImage" runat="server">
        ...
        <asp:HyperLink ID="CurrentLandlord" CssClass="loginlinks_img" runat="server" NavigateUrl="~/Student/Student_Profile.aspx">View House</asp:HyperLink>
    </div>
