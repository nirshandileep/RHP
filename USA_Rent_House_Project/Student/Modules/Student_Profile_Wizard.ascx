                                ...
                                <div id="div_register_User">
                                    ...
                                    <div id="formwrapper">
                                        ...
                                        <div id="Step1" runat="server">
                                            <div class="buttons">
                                                <asp:LinkButton ID="LinkButtonAddHouse" CssClass="smallbuttons" runat="server"
                                                    OnClick="LinkButtonAddHouse_Click">Add House</asp:LinkButton>
                                            </div>
                                        </div>
                                        <div id="Step2" runat="server" visible="false">
                                            <div class="buttons">
                                                <asp:LinkButton ID="LinkButtonOnCampus" CssClass="smallbuttons" runat="server"
                                                    OnClick="LinkButtonOnCampus_Click">On Campus</asp:LinkButton>
                                            </div>
                                            <div class="buttons">
                                                <asp:LinkButton ID="LinkButtonOffCampus" CssClass="smallbuttons" runat="server"
                                                    OnClick="LinkButtonOffCampus_Click">Off Campus</asp:LinkButton>
                                            </div>
                                        </div>
                                        <div id="Step3" runat="server" visible="false">
                                            <div class="buttons">
                                                <asp:LinkButton ID="HyperLink3" runat="server" CssClass="smallbuttons" OnClick="HyperLink3_Click"
                                                    OnClientClick="SetHouseType(1)">Dorms</asp:LinkButton>
                                            </div>
                                            <div class="buttons">
                                                <asp:LinkButton ID="HyperLink4" runat="server" CssClass="smallbuttons" OnClick="HyperLink4_Click"
                                                    OnClientClick="SetHouseType(2)">Appartments</asp:LinkButton>
                                            </div>
                                            <div class="buttons" style="display: none">
                                                <asp:LinkButton ID="HyperLink5" runat="server" CssClass="smallbuttons" OnClientClick="SetHouseType(3)">Condos</asp:LinkButton>
                                            </div>
                                            <div class="buttons" style="display: none">
                                                <asp:LinkButton ID="HyperLink6" runat="server" CssClass="smallbuttons" OnClientClick="SetHouseType(4)">Family Housing</asp:LinkButton>
                                            </div>
                                            <div class="buttons" style="display: none">
                                                <asp:LinkButton ID="HyperLink7" runat="server" CssClass="smallbuttons" OnClientClick="SetHouseType(9)">Houses</asp:LinkButton>
                                            </div>
                                        </div>
