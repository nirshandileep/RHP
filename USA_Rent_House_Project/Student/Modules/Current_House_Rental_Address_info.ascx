...
<p>
    ...
    <asp:CheckBox ID="chknotavailable" runat="server" Text="Not Available" AutoPostBack="true" oncheckedchanged="chknotavailable_CheckedChanged" />
...
<p>
    ...
    <asp:RequiredFieldValidator ID="AddressRequiredField" runat="server" ControlToValidate="Address"
        CssClass="failureNotification" ErrorMessage="Address is required." ToolTip="Address is required." ValidationGroup="ValidationGroup2">*</asp:RequiredFieldValidator>
</p>
<p>
    ...
    <asp:RequiredFieldValidator ID="CityRequiredField" runat="server" ControlToValidate="City"
        CssClass="failureNotification" ErrorMessage="City is required." ToolTip="City is required." ValidationGroup="ValidationGroup2">*</asp:RequiredFieldValidator>
</p>
<p>
...
<p>
    ...
    <asp:TextBox ID="Zip" runat="server" CssClass="textEntry textbox_w3" MaxLength="5" Enabled="false"></asp:TextBox>
    <asp:RequiredFieldValidator ID="ZipRequiredField" runat="server" ControlToValidate="Zip"
        CssClass="failureNotification" ErrorMessage="Zip is required." ToolTip="Zip is required." ValidationGroup="ValidationGroup2">*</asp:RequiredFieldValidator>
    <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ErrorMessage="Zip must be 5 numbers"
        ControlToValidate="Zip" CssClass="failureNotification" ValidationExpression="^[0-9]{5}$" ValidationGroup="ValidationGroup2">*</asp:RegularExpressionValidator>
</p>
 <p>
