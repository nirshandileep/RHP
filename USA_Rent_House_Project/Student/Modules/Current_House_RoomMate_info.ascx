<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Current_House_RoomMate_info.ascx.cs" Inherits="USA_Rent_House_Project.Student.Modules.Current_House_RoomMate_info" %>
...
<p>
    ...
    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="Mobile"
        CssClass="failureNotification" ErrorMessage="Best Contact No is required." ToolTip="Best Contact No is required." ValidationGroup="ValidationGroup3">*</asp:RequiredFieldValidator>
...
<p>
    <asp:Button ID="CreateRommateButton" runat="server" CssClass="actionbutton" 
        CommandName="MoveNext" Text="Save and continue" 
        onclick="CreateRommateButton_Click" ValidationGroup="ValidationGroup3" />
