...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div class="socialmediaicons">
        <a href="https://www.facebook.com/ratemystudenthousingandme?ref=aymt_homepage_panel"
            target="_blank">
            <img src="./Home Page_files/icon-fb.jpg"></a> <a href="https://plus.google.com/116442819890932165126/"
                target="_blank">
                <img src="./Home Page_files/icon-googleplus.jpg"></a> <a href="http://instagram.com/nirmal_abeygunaratne/"
                    target="_blank">
                    <img src="./Home Page_files/icon-insta.jpg"></a> <a href="https://twitter.com/nirmalabey/"
                        target="_blank">
                        <img src="./Home Page_files/icon-twiiter.jpg"></a> <a href="https://www.linkedin.com/pub/nirmal-abeygunaratne/a1/47b/906"
                            target="_blank">
                            <img src="./Home Page_files/icon-linkdin.jpg"></a>
        <div class="clear">
        </div>
    </div>
