...
{
    [DataContract]
    public class FBGraph : IOAuth2Graph
    {
        private static DataContractJsonSerializer jsonSerializer = new DataContractJsonSerializer(typeof(FBGraph));
        ...
        public static FBGraph Deserialize(string json)
        {
        ...
        public static FBGraph Deserialize(Stream jsonStream)
        {
            if (jsonStream == null)
            {
            ...
            return (FBGraph)jsonSerializer.ReadObject(jsonStream);
        }
